-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'APPLICANT', 'LENDER');

-- CreateEnum
CREATE TYPE "ConversationType" AS ENUM ('ADMIN_APPLICANT', 'MULTI_PARTY');
...
CREATE TABLE "Conversation" (
    "id" TEXT NOT NULL,
    "type" "ConversationType" NOT NULL DEFAULT 'ADMIN_APPLICANT',
